    ...
    >
      ...
      <div style={{ maxWidth: '760px', margin: '0 auto', padding: '4rem 2rem 6rem' }}>
        ...
        <h1
          style={{
            ...
            fontFamily: 'sans-serif',
            marginBottom: '0.4rem',
            background: 'linear-gradient(135deg, var(--text), #ec4899)',
        ...
        >
          TL;DR — We do not track you, sell your data, or store anything longer than
          necessary. Privacy is not a feature here — it is the foundation.
        </div>
        ...
        >
          {[
            ...
            >
              ...
              <div style={{ color: 'var(--muted)', fontSize: '0.8rem' }}>{card.desc}</div>
            </div>
          ))}
        </div>
      ...
      >
        <p>
          ...
          <a
            href="/terms"
            style={{ color: '#a78bfa', margin: '0 0.5rem', textDecoration: 'none' }}
          >
            Terms
          </a>
          <a
