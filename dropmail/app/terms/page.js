    ...
    <div style={{ background: '#0a0a12', minHeight: '100vh', color: '#e2e2f0', fontFamily: 'Georgia, serif' }}>
      ...
      <div style={{ maxWidth: '760px', margin: '0 auto', padding: '4rem 2rem 6rem' }}>
        ...
        {[
          ...
          {
            title: '5. Paid Plans',
            body: 'Paid subscriptions (Phantom, Spectre) are billed monthly. Refunds are handled case-by-case — contact support@ghostmails.org. We reserve the right to change pricing with 30 days notice.',
          },
          {
