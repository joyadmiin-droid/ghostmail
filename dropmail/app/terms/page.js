export default function TermsPage() {
  const headingStyle = { fontSize: '1.05rem', fontFamily: 'sans-serif', fontWeight: '700', color: '#e2e2f0', marginBottom: '0.6rem', paddingBottom: '0.4rem', borderBottom: '1px solid #1a1a2e' };
  const paraStyle = { color: '#666', lineHeight: '1.8', fontSize: '0.95rem' };
  const linkStyle = { color: '#a78bfa', textDecoration: 'none' };
  ...
  return (
    <div style={{ background: '#0a0a12', minHeight: '100vh', color: '#e2e2f0', fontFamily: 'Georgia, serif' }}>
      ...
      <div style={{ maxWidth: '760px', margin: '0 auto', padding: '4rem 2rem 6rem' }}>
        ...
        <h1 style={{ fontSize: '2.2rem', fontWeight: '800', fontFamily: 'sans-serif', color: '#e2e2f0', marginBottom: '0.4rem' }}>
          Terms of Service
        </h1>
